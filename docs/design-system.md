...
| Class | Use |
| --- | --- |
| `font-display font-extrabold uppercase leading-[0.95]` | page and hero titles, event names, big numbers (countdowns, room numbers, day numbers). 34–42px page titles, 22–26px section/card titles. |
| `font-sans` (Poppins, default) | all UI and body text. Headings inside cards: `font-semibold`. Avoid `font-black` on Poppins. |
| `font-mono` | times, dates, amounts (`tabular-nums`), small uppercase labels |
| `section-label` | small uppercase mono label above a group ("Voor jou") |
...
- **Modals, drawers, menus, popovers:** `bg-surface border-1.5 border-line`, may keep
