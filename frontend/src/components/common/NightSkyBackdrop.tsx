...
/** Shared night-sky-over-ocean decoration for full-screen status pages
 * (forbidden, crashed, etc.) — stars, a moon, and animated wave layers.
 * Render inside a positioned wrapper (e.g. `fixed inset-0`); page content
 * goes alongside this as a sibling with `relative z-10`. */
