...
export const apiRoutes = {
  ...
  admin: {
    ...
    events: {
      ...
      byId:         (id: string) => `/api/admin/events/${id}`,
      bulkDelete:   "/api/admin/events/bulk-delete",
      bulkSetGroup: "/api/admin/events/bulk-set-group",
      allDays:      "/api/admin/event-days",
      days:         (eventId: string) => `/api/admin/events/${eventId}/days`,
      dayById:      (dayId: string) => `/api/admin/event-days/${dayId}`,
      dayParticipant: (dayId: string, p: string) => `/api/admin/event-days/${dayId}/participants/${encodeURIComponent(p)}`,
      dayBulkRsvp:  (dayId: string) => `/api/admin/event-days/${dayId}/bulk-rsvp`,
